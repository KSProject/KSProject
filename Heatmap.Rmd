...
concepts_2$Symptoms <- factor(concepts_2$Symptoms, levels = c("Immune", "Hearing", 
                                                              "Opthalmalogic", "Post−pubertal regression",
                                                              "Cognition", "Cardiorespiratory",  "Sleep",
                                                              "Emotional", "Gastrointentinal", 
                                                              "Neurological",
                                                              "Behavioral  & Neurodevelopmental", "Motor",
                                                              "Communication"))
...
ind_impacts_2$Impacts <- factor(ind_impacts_2$Impacts, levels = c("Education impact",
                                                                  "Daily living impact",
                                                                  "Social impact",
                                                                  "Health impact"))
#heatmap
...
care_impacts_2$Impacts <- factor(care_impacts_2$Impacts, levels = c("Education impact",
                                                                  "Daily living impact",
                                                                  "Social impact",
                                                                  "Health impact"))
