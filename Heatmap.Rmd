...
colnames(concepts_2) <- c("Symptoms", "1", "2", "3", "4")
concepts_2 <- pivot_longer(concepts_2, cols = c(`1`, `2`, `3`, `4`), names_to = "age", values_to = "Frequencies")
...
#heatmap
 ggplot(concepts_2, aes(x=age, y=Symptoms, fill= Frequencies)) +
   ...
   scale_x_discrete(expand = c(0, 0),position = 'top', labels = c("Under 2", ) +
   theme_minimal() +  
