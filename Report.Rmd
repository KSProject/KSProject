...
```{r bar-plot, fig.width=9, fig.height = 11, echo = FALSE, fig.cap = "Total references bar chart."}
grid.arrange(p5)
```

### Analysis

From Figure \@ref(fig:bar-plot), we are able to make some simple observations. The most referenced KS Defining Concept across all age groups was Communication. The most referenced KS Individual Impact was health compared to emotional being the most referenced caregiver impact across all age groups. The Age bar plot allows to observe that in their interviews, caregivers most often referenced their children between the ages of 5 and 11.
