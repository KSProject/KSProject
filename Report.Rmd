...
Impacts")
p1 <- p1 + theme(
  axis.title.y = element_text(margin = margin(t = 0, r = 39, b = 0, l = 10, unit = "pt"))
)
...
Impacts")
p2 <- p2 + theme(
  axis.title.y = element_text(margin = margin(t = 0, r = 124, b = 0, l = 10, unit = "pt"))
)
...
Features")
p3 <- p3 + theme(
  axis.title.y = element_text(margin = margin(t = 0, r = 54, b = 0, l = 10, unit = "pt"))
)
...
p4 <- ggplot(Age1, aes(x = total, y = reorder(age, total), fill = color_value)) +
  ...
  labs(x = NULL, y = "Age")
p4 <- p4 + theme(
  axis.title.y = element_text(margin = margin(t = 0, r = 0, b = 0, l = 10, unit = "pt"))
)
