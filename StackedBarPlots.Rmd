...
ggplot(symptoms, aes(fill=symptom, y=value, x=age)) + 
  geom_bar(position="fill", stat="identity") +
  labs(x = "Age Group", y = "Proportion of References") + 
  theme_linedraw() +
  scale_fill_manual(name = "KS Defining Concepts",
...
ggplot(ind_impacts, aes(fill=impact, y=value, x=age)) + 
  geom_bar(position="fill", stat="identity") +
  labs(x = "Age Group", y = "Proportion of References") + 
  theme_linedraw() +
  scale_fill_manual(name = "KS Individual Impacts",
...
ggplot(care_impacts, aes(fill=impact, y=value, x=age)) + 
  geom_bar(position="fill", stat="identity") +
  labs(x = "Age Group", y = "Proportion of References") + 
  theme_linedraw() +
  scale_fill_manual(name = "KS Caregiver Impacts",
                    values = c("#cc6666", "#ccb966","#2d9f48", "#6b98e6"))+
  scale_x_discrete(labels=c("<2","2-4","5-11", "12-17"))
```